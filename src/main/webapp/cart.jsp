...
<c:remove var="failedMsg" scope="session"/>
 ...
 <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text"  name="username" class="form-control" id="inputEmail4" value="<%=u.getName() %>" readonly="readonly">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Email</label>
      <input name="email" type="email" class="form-control" id="inputPassword4" value="<%=u.getEmail() %>" readonly="readonly">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="number" name="phno" class="form-control" id="inputEmail4" value="<%= u.getPhno()%>"readonly="readonly">
    </div>
    <div class="form-group col-md-6">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="number"   name="zip" class="form-control" id="inputPassword4" >
    </div>
  </div>
